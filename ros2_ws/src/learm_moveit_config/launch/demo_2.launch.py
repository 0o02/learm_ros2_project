...
def generate_launch_description():
    ...
    # 参数文件路径（用于 serial_action_server_binary）
    ...
    qt_controller_node = Node(
        ...
        executable='learm_qt_controller',        # 与 setup.py 中 console_scripts 名称一致
        name='learn_qt_controller_node',         # 用户希望的节点名称
        output='screen',
